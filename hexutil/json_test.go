...
var unmarshalBytesTests = []unmarshalTest{
	...
	{input: `"Mx0"`, wantErr: wrapTypeError(ErrOddLength, bytesT)},
	{input: `"Mxxx"`, wantErr: wrapTypeError(ErrSyntax, bytesT)},
	{input: `"Mx01zz01"`, wantErr: wrapTypeError(ErrSyntax, bytesT)},

	// valid encoding
	{input: `""`, want: referenceBytes("")},
	{input: `"Mx"`, want: referenceBytes("")},
	{input: `"Mx02"`, want: referenceBytes("02")},
	{input: `"MX02"`, want: referenceBytes("02")},
	{input: `"Mxffffffffff"`, want: referenceBytes("ffffffffff")},
	{
...
func BenchmarkUnmarshalBytes(b *testing.B) {
	input := []byte(`"Mx123456789abcdef123456789abcdef"`)
	for i := 0; i < b.N; i++ {
		var v Bytes
...
var unmarshalBigTests = []unmarshalTest{
	...
	{input: `"Mx"`, wantErr: wrapTypeError(ErrEmptyNumber, bigT)},
	{input: `"Mx01"`, wantErr: wrapTypeError(ErrLeadingZero, bigT)},
	{input: `"Mxx"`, wantErr: wrapTypeError(ErrSyntax, bigT)},
	{input: `"Mx1zz01"`, wantErr: wrapTypeError(ErrSyntax, bigT)},
	{
...
var unmarshalUint64Tests = []unmarshalTest{
	...
	{input: `"M"`, wantErr: wrapTypeError(ErrMissingPrefix, uint64T)},
	{input: `"Mx"`, wantErr: wrapTypeError(ErrEmptyNumber, uint64T)},
	{input: `"Mx01"`, wantErr: wrapTypeError(ErrLeadingZero, uint64T)},
	{input: `"Mxfffffffffffffffff"`, wantErr: wrapTypeError(ErrUint64Range, uint64T)},
	{input: `"Mxx"`, wantErr: wrapTypeError(ErrSyntax, uint64T)},
	{input: `"Mx1zz01"`, wantErr: wrapTypeError(ErrSyntax, uint64T)},
...
var unmarshalUintTests = []unmarshalTest{
	...
	{input: `"M"`, wantErr: wrapTypeError(ErrMissingPrefix, uintT)},
	{input: `"Mx"`, wantErr: wrapTypeError(ErrEmptyNumber, uintT)},
	{input: `"Mx01"`, wantErr: wrapTypeError(ErrLeadingZero, uintT)},
	{input: `"Mx100000000"`, want: uint(maxUint33bits), wantErr32bit: wrapTypeError(ErrUintRange, uintT)},
	{input: `"Mxfffffffffffffffff"`, wantErr: wrapTypeError(ErrUintRange, uintT)},
	{input: `"Mxx"`, wantErr: wrapTypeError(ErrSyntax, uintT)},
	{input: `"Mx1zz01"`, wantErr: wrapTypeError(ErrSyntax, uintT)},

	// valid encoding
	{input: `""`, want: uint(0)},
	{input: `"Mx0"`, want: uint(0)},
	{input: `"Mx2"`, want: uint(0x2)},
	{input: `"Mx2F2"`, want: uint(0x2f2)},
	{input: `"MX2F2"`, want: uint(0x2f2)},
	{input: `"Mx1122aaff"`, want: uint(0x1122aaff)},
	{input: `"Mxbbb"`, want: uint(0xbbb)},
	{input: `"Mxffffffff"`, want: uint(0xffffffff)},
	{input: `"Mxffffffffffffffff"`, want: uint(maxUint64bits), wantErr32bit: wrapTypeError(ErrUintRange, uintT)},
}
...
func TestUnmarshalFixedUnprefixedText(t *testing.T) {
	tests := []struct {
		...
		{input: "Mx444444gg", wantErr: ErrSyntax, want: []byte{0, 0, 0, 0}},
		// valid inputs
		{input: "44444444", want: []byte{0x44, 0x44, 0x44, 0x44}},
		{input: "Mx44444444", want: []byte{0x44, 0x44, 0x44, 0x44}},
	}
