...
func (c *Commission) ExportV1(state *types.AppState, id types.CoinID) {
	state.Commission = types.Commission{
		...
		CreateTicker3:           helpers.BipToPip(big.NewInt(100000 - 10)).String(),
		CreateTicker4:           helpers.FloatBipToPip(10000 - 10).String(),
		CreateTicker5:           helpers.FloatBipToPip(1000 - 10).String(),
		CreateTicker6:           helpers.FloatBipToPip(100 - 10).String(),
		CreateCoin:              helpers.FloatBipToPip(10).String(),
		CreateToken:             helpers.FloatBipToPip(10).String(),
...
func (c *Commission) GetCommissions() *Price {
	...
	if len(value) == 0 {
		return &Price{
			...
			CreateCoin:       helpers.StringToBigInt("10000000000000000000000"),
			CreateToken:      helpers.StringToBigInt("10000000000000000000000"),
