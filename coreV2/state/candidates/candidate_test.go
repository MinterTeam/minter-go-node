...
func TestCandidates_Commit_createThreeCandidatesWithInitialHeight(t *testing.T) {
	...
	candidates.Create([20]byte{1}, [20]byte{2}, [20]byte{3}, [32]byte{4}, 10, 0, 0)
	candidates.Create([20]byte{11}, [20]byte{21}, [20]byte{31}, [32]byte{41}, 10, 0, 0)
	...
	// }
	candidates.Create([20]byte{1, 1}, [20]byte{2, 2}, [20]byte{3, 3}, [32]byte{4, 4}, 10, 0, 0)
...
func TestCandidates_Count(t *testing.T) {
	...
	candidates.Create([20]byte{1}, [20]byte{2}, [20]byte{3}, [32]byte{4}, 10, 0, 0)
	candidates.Create([20]byte{1, 1}, [20]byte{2, 2}, [20]byte{3, 3}, [32]byte{4, 4}, 20, 0, 0)
	candidates.Create([20]byte{1, 1, 1}, [20]byte{2, 2, 2}, [20]byte{3, 3, 3}, [32]byte{4, 4, 4}, 30, 0, 0)
...
func TestCandidates_GetNewCandidates(t *testing.T) {
	...
	candidates.Create([20]byte{1}, [20]byte{2}, [20]byte{3}, [32]byte{5}, 10, 0, 0)
...
func TestCandidates_CalculateBipValue_RecalculateStakes_GetTotalStake(t *testing.T) {
	...
	candidates.Create([20]byte{1}, [20]byte{1}, [20]byte{1}, [32]byte{1}, 1, 0, 0)
