...
func TestRedeemCheckTxToDecodeError(t *testing.T) {
	...
	txResponse := NewExecutor(GetData).RunTx(cState, encodedTx, big.NewInt(0), 0, &sync.Map{}, 0, false)
...
func TestRedeemCheckTxToCheckData(t *testing.T) {
	...
	response = NewExecutor(GetData).RunTx(cState, encodedTx, big.NewInt(0), 100, &sync.Map{}, 0, false)
