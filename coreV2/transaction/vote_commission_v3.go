...
type VoteCommissionDataV3 struct {
	PubKey                  types.Pubkey
	Height                  uint64
	Coin                    types.CoinID
	PayloadByte             *big.Int
...
func (data VoteCommissionDataV3) Gas() int64 {
	return gasVoteCommission
}

func (data VoteCommissionDataV3) GetPubKey() types.Pubkey {
	return data.PubKey
}
...
func (data VoteCommissionDataV3) String() string {
	return fmt.Sprintf("PRICE COMMISSION in coin: %d", data.Coin)
}

func (data VoteCommissionDataV3) CommissionData(price *commission.Price) *big.Int {
	return price.VoteCommission
}

func (data VoteCommissionDataV3) Run(tx *Transaction, context state.Interface, rewardPool *big.Int, currentBlock uint64, price *big.Int) Response {
	sender, _ := tx.Sender()
...
func (data VoteCommissionDataV3) price() *commission.Price {
