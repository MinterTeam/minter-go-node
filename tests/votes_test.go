...
func TestVoteCommissionOKUpdateVersion(t *testing.T) {
	...
	SendBeginBlock(app, haltBlockV210)

	SendEndBlock(app, haltBlockV210) // send EndBlock
	SendCommit(app)                  // send Commit

	SendBeginBlock(app, haltBlockV210+1)
	SendEndBlock(app, haltBlockV210+1) // send EndBlock
	SendCommit(app)                    // send Commit
	...
	SendEndBlock(app, haltBlockV210+2) // send EndBlock
	SendCommit(app)                    // send Commit
	...
	SendEndBlock(app, haltBlockV210+3) // send EndBlock
	SendCommit(app)                    // send Commit

	SendBeginBlock(app, haltBlockV210+4)
	SendEndBlock(app, haltBlockV210+4) // send EndBlock
	SendCommit(app)                    // send Commit
