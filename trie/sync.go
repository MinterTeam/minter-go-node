...
func NewTrieSync(root types.Hash, database DatabaseReader, callback LeafCallback) *TrieSync {
	ts := &TrieSync{
		database: database,
...
func (s *TrieSync) AddSubTrie(root types.Hash, depth int, parent types.Hash, callback LeafCallback) {
...
func (s *TrieSync) Commit(dbw mintdb.Putter) (int, error) {
