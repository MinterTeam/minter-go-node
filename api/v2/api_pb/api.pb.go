...
type NetInfoResponse struct {
	...
	CountPeers           string                  `protobuf:"bytes,2,opt,name=count_peers,json=countPeers,proto3" json:"count_peers"`
...
type NetInfoResponse_Peer_ConnectionStatus_Monitor struct {
	...
	InstRate             string   `protobuf:"bytes,6,opt,name=inst_rate,json=instRate,proto3" json:"inst_rate"`
	CurRate              string   `protobuf:"bytes,7,opt,name=cur_rate,json=curRate,proto3" json:"cur_rate"`
	AvgRate              string   `protobuf:"bytes,8,opt,name=avg_rate,json=avgRate,proto3" json:"avg_rate"`
	PeakRate             string   `protobuf:"bytes,9,opt,name=peak_rate,json=peakRate,proto3" json:"peak_rate"`
	BytesRem             string   `protobuf:"bytes,10,opt,name=bytes_rem,json=bytesRem,proto3" json:"bytes_rem"`
	TimeRem              string   `protobuf:"bytes,11,opt,name=time_rem,json=timeRem,proto3" json:"time_rem"`
	Progress             string   `protobuf:"bytes,12,opt,name=progress,proto3" json:"progress"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type NetInfoResponse_Peer_ConnectionStatus_Channel struct {
	...
	SendQueueCapacity    string   `protobuf:"bytes,1,opt,name=send_queue_capacity,json=sendQueueCapacity,proto3" json:"send_queue_capacity"`
	SendQueueSize        string   `protobuf:"bytes,2,opt,name=send_queue_size,json=sendQueueSize,proto3" json:"send_queue_size"`
	Priority             string   `protobuf:"bytes,3,opt,name=priority,proto3" json:"priority"`
	RecentlySent         string   `protobuf:"bytes,4,opt,name=recently_sent,json=recentlySent,proto3" json:"recently_sent"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type StatusResponse struct {
	...
	KeepLastStates       string   `protobuf:"bytes,5,opt,name=keep_last_states,json=keepLastStates,proto3" json:"keep_last_states"`
...
type GenesisResponse struct {
	GenesisTime          string                           `protobuf:"bytes,1,opt,name=genesis_time,json=genesisTime,proto3" json:"genesis_time"`
	ChainId              string                           `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id"`
	ConsensusParams      *GenesisResponse_ConsensusParams `protobuf:"bytes,3,opt,name=consensus_params,json=consensusParams,proto3" json:"consensus_params"`
	AppHash              string                           `protobuf:"bytes,4,opt,name=app_hash,json=appHash,proto3" json:"app_hash"`
	AppState             *_struct.Struct                  `protobuf:"bytes,5,opt,name=app_state,json=appState,proto3" json:"app_state"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
type GenesisResponse_ConsensusParams struct {
	Block                *GenesisResponse_ConsensusParams_Block     `protobuf:"bytes,1,opt,name=block,proto3" json:"block"`
	Evidence             *GenesisResponse_ConsensusParams_Evidence  `protobuf:"bytes,2,opt,name=evidence,proto3" json:"evidence"`
	Validator            *GenesisResponse_ConsensusParams_Validator `protobuf:"bytes,3,opt,name=validator,proto3" json:"validator"`
	XXX_NoUnkeyedLiteral struct{}                                   `json:"-"`
	XXX_unrecognized     []byte                                     `json:"-"`
	XXX_sizecache        int32                                      `json:"-"`
}
...
type GenesisResponse_ConsensusParams_Block struct {
	MaxBytes             string   `protobuf:"bytes,1,opt,name=max_bytes,json=maxBytes,proto3" json:"max_bytes"`
	MaxGas               string   `protobuf:"bytes,2,opt,name=max_gas,json=maxGas,proto3" json:"max_gas"`
	TimeIotaMs           string   `protobuf:"bytes,3,opt,name=time_iota_ms,json=timeIotaMs,proto3" json:"time_iota_ms"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type GenesisResponse_ConsensusParams_Evidence struct {
	MaxAgeNumBlocks      string   `protobuf:"bytes,1,opt,name=max_age_num_blocks,json=maxAgeNumBlocks,proto3" json:"max_age_num_blocks"`
	MaxAgeDuration       string   `protobuf:"bytes,2,opt,name=max_age_duration,json=maxAgeDuration,proto3" json:"max_age_duration"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type GenesisResponse_ConsensusParams_Validator struct {
	PublicKeyTypes       []string `protobuf:"bytes,1,rep,name=public_key_types,json=publicKeyTypes,proto3" json:"public_key_types"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type MinGasPriceResponse struct {
	MinGasPrice          string   `protobuf:"bytes,3,opt,name=min_gas_price,json=minGasPrice,proto3" json:"min_gas_price"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type BlockResponse struct {
	...
	TransactionsCount    string                       `protobuf:"bytes,4,opt,name=transactions_count,json=transactionsCount,proto3" json:"transactions_count"`
	Transactions         []*BlockResponse_Transaction `protobuf:"bytes,6,rep,name=transactions,proto3" json:"transactions"`
	BlockReward          string                       `protobuf:"bytes,7,opt,name=block_reward,json=blockReward,proto3" json:"block_reward"`
	Size                 string                       `protobuf:"bytes,8,opt,name=size,proto3" json:"size"`
	Proposer             string                       `protobuf:"bytes,9,opt,name=proposer,proto3" json:"proposer"`
	Validators           []*BlockResponse_Validator   `protobuf:"bytes,10,rep,name=validators,proto3" json:"validators"`
	Evidence             *BlockResponse_Evidence      `protobuf:"bytes,11,opt,name=evidence,proto3" json:"evidence"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
type BlockResponse_Transaction struct {
	Hash                 string            `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash"`
	RawTx                string            `protobuf:"bytes,2,opt,name=raw_tx,json=rawTx,proto3" json:"raw_tx"`
	...
	Data                 *_struct.Struct   `protobuf:"bytes,7,opt,name=data,proto3" json:"data"`
	Payload              []byte            `protobuf:"bytes,8,opt,name=payload,proto3" json:"payload"`
	ServiceData          []byte            `protobuf:"bytes,9,opt,name=service_data,json=serviceData,proto3" json:"service_data"`
	Gas                  string            `protobuf:"bytes,10,opt,name=gas,proto3" json:"gas"`
	GasCoin              string            `protobuf:"bytes,11,opt,name=gas_coin,json=gasCoin,proto3" json:"gas_coin"`
	Tags                 map[string]string `protobuf:"bytes,12,rep,name=tags,proto3" json:"tags" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Code                 string            `protobuf:"bytes,13,opt,name=code,proto3" json:"code"`
	Log                  string            `protobuf:"bytes,14,opt,name=log,proto3" json:"log"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type BlockResponse_Validator struct {
	...
	Signed               bool     `protobuf:"varint,2,opt,name=signed,proto3" json:"signed"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type BlockResponse_Evidence struct {
	Evidence             []*BlockResponse_Evidence_Evidence `protobuf:"bytes,1,rep,name=evidence,proto3" json:"evidence"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}
...
type MaxGasRequest struct {
	Height               int32    `protobuf:"varint,1,opt,name=height,proto3" json:"height"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type MaxGasResponse struct {
	MaxGas               string   `protobuf:"bytes,3,opt,name=max_gas,json=maxGas,proto3" json:"max_gas"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type AddressResponse struct {
	Balance              map[string]string `protobuf:"bytes,1,rep,name=balance,proto3" json:"balance" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	TransactionsCount    string            `protobuf:"bytes,2,opt,name=transactions_count,json=transactionsCount,proto3" json:"transactions_count"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type AddressesRequest struct {
	Addresses            []string `protobuf:"bytes,1,rep,name=addresses,proto3" json:"addresses"`
	Height               int32    `protobuf:"varint,2,opt,name=height,proto3" json:"height"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
type AddressesResponse struct {
	Addresses            []*AddressesResponse_Result `protobuf:"bytes,3,rep,name=addresses,proto3" json:"addresses"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
type AddressesResponse_Result struct {
	Address              string            `protobuf:"bytes,1,opt,name=address,proto3" json:"address"`
	Balance              map[string]string `protobuf:"bytes,2,rep,name=balance,proto3" json:"balance" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	TransactionsCount    string            `protobuf:"bytes,3,opt,name=transactions_count,json=transactionsCount,proto3" json:"transactions_count"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type CandidateResponse struct {
	RewardAddress        string                     `protobuf:"bytes,1,opt,name=reward_address,json=rewardAddress,proto3" json:"reward_address"`
	TotalStake           string                     `protobuf:"bytes,2,opt,name=total_stake,json=totalStake,proto3" json:"total_stake"`
	PublicKey            string                     `protobuf:"bytes,3,opt,name=public_key,json=publicKey,proto3" json:"public_key"`
	Commission           string                     `protobuf:"bytes,4,opt,name=commission,proto3" json:"commission"`
	Stakes               []*CandidateResponse_Stake `protobuf:"bytes,5,rep,name=stakes,proto3" json:"stakes"`
...
type CandidateResponse_Stake struct {
	...
	BipValue             string   `protobuf:"bytes,4,opt,name=bip_value,json=bipValue,proto3" json:"bip_value"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type CandidatesRequest struct {
	Height               int32    `protobuf:"varint,1,opt,name=height,proto3" json:"height"`
	IncludeStakes        bool     `protobuf:"varint,2,opt,name=include_stakes,json=includeStakes,proto3" json:"include_stakes"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type CandidatesResponse struct {
	Candidates           []*CandidateResponse `protobuf:"bytes,3,rep,name=candidates,proto3" json:"candidates"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
type CoinInfoResponse struct {
	...
	Symbol               string   `protobuf:"bytes,2,opt,name=symbol,proto3" json:"symbol"`
	Volume               string   `protobuf:"bytes,3,opt,name=volume,proto3" json:"volume"`
	Crr                  string   `protobuf:"bytes,4,opt,name=crr,proto3" json:"crr"`
	ReserveBalance       string   `protobuf:"bytes,5,opt,name=reserve_balance,json=reserveBalance,proto3" json:"reserve_balance"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type SendTransactionRequest struct {
	Tx                   string   `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type TransactionResponse struct {
	Hash                 string            `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash"`
	RawTx                string            `protobuf:"bytes,2,opt,name=raw_tx,json=rawTx,proto3" json:"raw_tx"`
	Height               string            `protobuf:"bytes,3,opt,name=height,proto3" json:"height"`
	...
	Gas                  string            `protobuf:"bytes,7,opt,name=gas,proto3" json:"gas"`
	GasPrice             string            `protobuf:"bytes,8,opt,name=gas_price,json=gasPrice,proto3" json:"gas_price"`
	GasCoin              string            `protobuf:"bytes,9,opt,name=gas_coin,json=gasCoin,proto3" json:"gas_coin"`
	Type                 string            `protobuf:"bytes,10,opt,name=type,proto3" json:"type"`
	Data                 *_struct.Struct   `protobuf:"bytes,11,opt,name=data,proto3" json:"data"`
	Payload              []byte            `protobuf:"bytes,12,opt,name=payload,proto3" json:"payload"`
	Tags                 map[string]string `protobuf:"bytes,13,rep,name=tags,proto3" json:"tags" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Code                 string            `protobuf:"bytes,14,opt,name=code,proto3" json:"code"`
	Log                  string            `protobuf:"bytes,15,opt,name=log,proto3" json:"log"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type TransactionsResponse struct {
	Transactions         []*TransactionResponse `protobuf:"bytes,3,rep,name=transactions,proto3" json:"transactions"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
type TransactionsRequest struct {
	...
	PerPage              int32    `protobuf:"varint,3,opt,name=per_page,json=perPage,proto3" json:"per_page"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type EstimateCoinBuyRequest struct {
	CoinToBuy            string   `protobuf:"bytes,1,opt,name=coin_to_buy,json=coinToBuy,proto3" json:"coin_to_buy"`
	CoinToSell           string   `protobuf:"bytes,2,opt,name=coin_to_sell,json=coinToSell,proto3" json:"coin_to_sell"`
	ValueToBuy           string   `protobuf:"bytes,3,opt,name=value_to_buy,json=valueToBuy,proto3" json:"value_to_buy"`
...
type EstimateCoinBuyResponse struct {
	WillPay              string   `protobuf:"bytes,1,opt,name=will_pay,json=willPay,proto3" json:"will_pay"`
	Commission           string   `protobuf:"bytes,2,opt,name=commission,proto3" json:"commission"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type EstimateCoinSellRequest struct {
	CoinToSell           string   `protobuf:"bytes,1,opt,name=coin_to_sell,json=coinToSell,proto3" json:"coin_to_sell"`
	CoinToBuy            string   `protobuf:"bytes,2,opt,name=coin_to_buy,json=coinToBuy,proto3" json:"coin_to_buy"`
	ValueToSell          string   `protobuf:"bytes,3,opt,name=value_to_sell,json=valueToSell,proto3" json:"value_to_sell"`
	Height               int32    `protobuf:"varint,4,opt,name=height,proto3" json:"height"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
type EstimateCoinSellResponse struct {
	WillGet              string   `protobuf:"bytes,1,opt,name=will_get,json=willGet,proto3" json:"will_get"`
	Commission           string   `protobuf:"bytes,2,opt,name=commission,proto3" json:"commission"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
type EstimateCoinSellAllRequest struct {
	...
	CoinToBuy            string   `protobuf:"bytes,2,opt,name=coin_to_buy,json=coinToBuy,proto3" json:"coin_to_buy"`
	ValueToSell          string   `protobuf:"bytes,3,opt,name=value_to_sell,json=valueToSell,proto3" json:"value_to_sell"`
	GasPrice             uint64   `protobuf:"varint,4,opt,name=gas_price,json=gasPrice,proto3" json:"gas_price"`
...
type EstimateTxCommissionResponse struct {
	Commission           string   `protobuf:"bytes,1,opt,name=commission,proto3" json:"commission"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type MissedBlocksResponse struct {
	MissedBlocks         string   `protobuf:"bytes,1,opt,name=missed_blocks,json=missedBlocks,proto3" json:"missed_blocks"`
	MissedBlocksCount    string   `protobuf:"bytes,2,opt,name=missed_blocks_count,json=missedBlocksCount,proto3" json:"missed_blocks_count"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type UnconfirmedTxsResponse struct {
	TransactionsCount    string   `protobuf:"bytes,1,opt,name=transactions_count,json=transactionsCount,proto3" json:"transactions_count"`
	TotalTransactions    string   `protobuf:"bytes,2,opt,name=total_transactions,json=totalTransactions,proto3" json:"total_transactions"`
	TotalBytes           string   `protobuf:"bytes,3,opt,name=total_bytes,json=totalBytes,proto3" json:"total_bytes"`
	Transactions         []string `protobuf:"bytes,4,rep,name=transactions,proto3" json:"transactions"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type ValidatorsResponse struct {
	Validators           []*ValidatorsResponse_Result `protobuf:"bytes,3,rep,name=validators,proto3" json:"validators"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
type SubscribeResponse struct {
	...
	Events               []*SubscribeResponse_Event `protobuf:"bytes,3,rep,name=events,proto3" json:"events"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
type SubscribeResponse_Event struct {
	...
	Events               []string `protobuf:"bytes,2,rep,name=events,proto3" json:"events"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
